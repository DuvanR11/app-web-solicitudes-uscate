      ...
      <div className="container max-w-7xl mx-auto px-4 py-8 md:py-12 grid grid-cols-1 xl:grid-cols-12 gap-10 items-center min-h-screen">
        ...
        <div className="hidden xl:flex xl:col-span-5 flex-col text-white animate-fade-in-down pl-8">
          ...
          <p className="text-lg text-slate-300 mb-8 max-w-md">
            Crea tu cuenta en segundos y empieza a reportar novedades en tu localidad.
          </p>
        ...
        <div className="col-span-1 xl:col-span-7 w-full flex justify-center xl:justify-end">
          ...
          <div className="w-full max-w-[600px] bg-white/95 backdrop-blur-xl p-6 md:p-10 rounded-[2rem] shadow-2xl relative">
            ...
            <h2 className="hidden xl:block text-[#002244] font-bold text-2xl mb-1">Formulario de Registro</h2>
            <p className="hidden xl:block text-slate-500 text-sm mb-8">Ingresa tus datos para darte de alta en el sistema.</p>
            ...
            <form onSubmit={handleRegister} className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="lg:col-span-2 relative group">
                  ...
                  <input
                    type="email" name="email" placeholder="Correo Electrónico" value={formData.email} onChange={handleChange} required
                    className="w-full bg-[#f4f7fa] border border-slate-200 text-[#002244] font-semibold rounded-xl py-3.5 pl-12 pr-4 outline-none focus:border-[#004080] focus:ring-2 focus:ring-[#004080]/10 transition-all placeholder:text-slate-400"
                  />
                </div>
                ...
                <div className="relative group">
                  ...
                  <input
                    type="tel" name="phone" placeholder="Celular" maxLength={10} value={formData.phone} onChange={handleChange} required
                    className="w-full bg-[#f4f7fa] border border-slate-200 text-[#002244] font-semibold rounded-xl py-3.5 pl-12 pr-4 outline-none focus:border-[#004080] focus:ring-2 focus:ring-[#004080]/10 transition-all placeholder:text-slate-400"
                  />
                </div>
                ...
                <div className="relative group">
                  ...
                  <input
                    type="number" name="documentNumber" placeholder="No. Documento" value={formData.documentNumber} onChange={handleChange} required
                ...
                <div className="lg:col-span-2 relative group">
                  ...
                  <select
                    name="locality" value={formData.locality} onChange={handleChange} required
                ...
                <div className="relative group">
                  ...
                  <input
                    type="password" name="password" placeholder="Contraseña" value={formData.password} onChange={handleChange} required
                    className="w-full bg-[#f4f7fa] border border-slate-200 text-[#002244] font-semibold rounded-xl py-3.5 pl-12 pr-4 outline-none focus:border-[#004080] focus:ring-2 focus:ring-[#004080]/10 transition-all placeholder:text-slate-400"
                  />
                </div>
                ...
                <div className="relative group">
                  ...
                  <input
                    type="password" name="confirmPassword" placeholder="Repetir Contraseña" value={formData.confirmPassword} onChange={handleChange} required
                    className="w-full bg-[#f4f7fa] border border-slate-200 text-[#002244] font-semibold rounded-xl py-3.5 pl-12 pr-4 outline-none focus:border-[#004080] focus:ring-2 focus:ring-[#004080]/10 transition-all placeholder:text-slate-400"
                  />
                </div>
              </div>
